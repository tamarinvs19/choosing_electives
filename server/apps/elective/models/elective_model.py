...
from .student_groups_model import StudentGroup
...
class ElectiveThematic(TimedModel):
    """
...
class KindOfElective(TimedModel):
    elective = models.ForeignKey(Elective, on_delete=models.CASCADE)
    kind = models.ForeignKey(ElectiveKind, on_delete=models.CASCADE)


class StudentOnElective(TimedModel):
    student = models.ForeignKey('Person', on_delete=models.SET_NULL, null=True, default=None)
    elective = models.ForeignKey(Elective, on_delete=models.SET_NULL, null=True, default=None)
    kind = models.ForeignKey(ElectiveKind, on_delete=models.SET_NULL, null=True, default=None)
...
class MandatoryElectiveInStudentGroup(TimedModel):
    elective = models.ForeignKey(Elective, on_delete=models.CASCADE)
