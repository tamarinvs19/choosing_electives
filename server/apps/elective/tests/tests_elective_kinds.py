...
from elective.models import ElectiveKind


class TestElectiveKinds(TestCase):
    def test_create_kind(self):
        new_kind: ElectiveKind = ElectiveKind.objects.create(
            credit_units=4, language='ru', semester=1)
    ...
    def test_modify_kind(self):
        ...
        self.assertEqual(new_kind.semester, 2)

    def test_modify_kind_free(self):
        _: ElectiveKind = ElectiveKind.objects.create(
            credit_units=3, language='en', semester=1)
        new_kind: ElectiveKind = ElectiveKind.objects.create(
            credit_units=4, language='ru', semester=1)
    ...
    def test_fields_of_kind_big_ru(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=4, language='ru', semester=1)

        self.assertEqual(new_kind.language, 'ru')
        self.assertEqual(new_kind.credit_units, 4)
        self.assertEqual(new_kind.semester, 1)

    def test_fields_of_kind_small_ru(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=3, language='ru', semester=1)
    ...
    def test_fields_of_kind_elective_ru(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=2, language='ru', semester=1)
    ...
    def test_fields_of_kind_big_en(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=4, language='en', semester=1)
    ...
    def test_fields_of_kind_small_en(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=3, language='en', semester=1)
    ...
    def test_fields_of_kind_elective_en(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=2, language='en', semester=1)

        self.assertEqual(new_kind.language, 'en')
        self.assertEqual(new_kind.credit_units, 2)
        self.assertEqual(new_kind.semester, 1)

    def test_semester_autumn(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=2, language='en', semester=1)
    ...
    def test_semester_spring(self):
        new_kind: ElectiveKind = \
            ElectiveKind.objects.create(credit_units=2, language='en', semester=2)
